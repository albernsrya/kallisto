...
def test_cli_print_help(runner):
    ...
    if result.exit_code != 0:
        raise AssertionError
    if "kallisto" not in result.output:
        raise AssertionError
...
def test_cli_bonds_constrain(runner, pyridine_xyz):
    ...
    if "$constrain" not in lines[0]:
        raise AssertionError
    if "distance: 1, 2, auto" not in lines[1]:
        raise AssertionError
    if "distance: 1, 6, auto" not in lines[2]:
        raise AssertionError
    if "distance: 1, 7, auto" not in lines[3]:
        raise AssertionError
    if "distance: 2, 1, auto" not in lines[4]:
        raise AssertionError
    if "distance: 2, 3, auto" not in lines[5]:
        raise AssertionError
    if "distance: 2, 8, auto" not in lines[6]:
        raise AssertionError
...
def test_cli_sort_with_start(runner, pyridine_xyz):
    ...
    if "11" not in result.output:
        raise AssertionError
    if "kallisto\nN      0.6816    1.1960    0.0000" not in result.output:
        raise AssertionError
